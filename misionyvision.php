      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-sm-push-6 col-xs-12">
            <img src="img/about_us/main.jpg" alt="image" class="img-responsive img-rounded">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-3 col-xs-12">
            <div class="teamContent">
              <div class="teamImage">
              <img src="img/home/team/team-2.jpg" alt="img" class="img-circle img-responsive">
                <div class="maskingContent">
                  <ul class="list-inline">
                    <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
          ...
          <div class="col-sm-3 col-xs-12">
            <div class="teamContent">
              <div class="teamImage">
              <img src="img/home/team/team-3.jpg" alt="img" class="img-circle img-responsive">
                <div class="maskingContent">
                  <ul class="list-inline">
                    <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
          ...
          <div class="col-sm-3 col-xs-12">
            <div class="teamContent">
              <div class="teamImage">
              <img src="img/home/team/team-4.jpg" alt="img" class="img-circle img-responsive">
                <div class="maskingContent">
                  <ul class="list-inline">
                    <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
